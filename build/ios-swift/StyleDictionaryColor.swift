...
public enum StyleDictionaryColor {
    ...
    public static let buttonPrimaryBackground = UIColor(red: 0.494, green: 0.000, blue: 0.667, alpha: 1)
    public static let buttonPrimaryText = UIColor(red: 1.000, green: 1.000, blue: 1.000, alpha: 1)
    public static let buttonSecondaryBackground = UIColor(red: 0.000, green: 1.000, blue: 0.098, alpha: 1)
