...
// Generated on Thu, 15 Sep 2022 08:58:51 GMT


#import "StyleDictionarySize.h"


float const TypographyPrimaryDefaultXxxlargeFontWeight = 400;
float const TypographyPrimaryDefaultXxlargeFontWeight = 400;
float const TypographyPrimaryDefaultXlargeFontWeight = 400;
float const TypographyPrimaryDefaultLargeFontWeight = 400;
float const TypographyPrimaryDefaultMediumFontWeight = 400;
float const TypographyPrimaryDefaultMediumTightFontWeight = 400;
float const TypographyPrimaryDefaultDefaultFontWeight = 400;
float const TypographyPrimaryDefaultDefaultTightFontWeight = 400;
float const TypographyPrimaryDefaultSmallFontWeight = 400;
float const TypographyPrimaryContrastXxxlargeFontWeight = 700;
float const TypographyPrimaryContrastXxlargeFontWeight = 700;
float const TypographyPrimaryContrastXlargeFontWeight = 700;
float const TypographyPrimaryContrastLargeFontWeight = 700;
float const TypographyPrimaryContrastMediumFontWeight = 700;
float const TypographyPrimaryContrastMediumTightFontWeight = 700;
float const TypographyPrimaryContrastDefaultRootFontWeight = 700;
float const TypographyPrimaryContrastDefaultTightFontWeight = 700;
float const TypographyPrimaryContrastSmallFontWeight = 700;
...
float const TypographyPrimaryfontDefaultXxxlargeFontWeight = 400;
float const TypographyPrimaryfontDefaultXxlargeFontWeight = 400;
float const TypographyPrimaryfontDefaultXlargeFontWeight = 400;
float const TypographyPrimaryfontDefaultLargeFontWeight = 400;
float const TypographyPrimaryfontDefaultMediumFontWeight = 400;
...
float const TypographySecondaryfontDefaultLargeFontWeight = 400;
float const TypographySecondaryfontDefaultMediumFontWeight = 400;
float const TypographySecondaryfontDefaultMediumTightFontWeight = 400;
float const TypographySecondaryfontDefaultDefaultFontWeight = 400;
float const TypographySecondaryfontDefaultSmallFontWeight = 400;
float const TypographySecondaryfontContrastXxxlargeFontWeight = 500;
float const TypographySecondaryfontContrastXxlargeFontWeight = 500;
float const TypographySecondaryfontContrastXlargeFontWeight = 500;
float const TypographySecondaryfontContrastLargeFontWeight = 500;
float const TypographySecondaryfontContrastMediumFontWeight = 500;
